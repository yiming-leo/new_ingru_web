...
const config: Config = {
  ...
  theme: {
    ...
    background: {
      'custom-blue': 'linear-gradient(90deg, #004DDC 0%, #4183FF 100%)',
    },
    minWidth: {
      '0': '0',
      '1/4': '25%',
    ...
    extend: {
      ...
      fontSize: {
        ...
        "title-sm2": ["22px", "28px"],
        "title-xsm": ["18px", "24px"],
        "title-2sm": ["1rem", "1.25rem"],
        "text-inputNum": ["1.25rem", "3rem"],
        // 分割
      ...
      backgroundImage: {
        'gradient-to-blue': 'linear-gradient(90deg, #004DDC 0%, #4183FF 100%)',
      },
      maxWidth: {
        2.5: "0.625rem",
        3: "0.75rem",
